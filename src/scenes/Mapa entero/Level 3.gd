...
signal terminal3Solved

func _on_Terminal_solved():
	emit_signal("terminal3Solved")
	enemy.hide()
...
onready var incorrectSound = get_node("incorrectSound")
...
func _on_Dialog1_answer(ans):
	print_debug(ans)
	if ans == 1 and fila.hasRose:
		children[0].finish(true,true)
		spawns[0].wasPicked = true
	elif ans == 1 and !fila.hasRose:
...
func _on_Portal_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position
	fila.fila[0].songNumber = 3

func _on_Portal2_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position
	fila.fila[0].songNumber = 2

func _on_Portal_correct_1_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position

func _on_Portal_incorrect_1_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position
	incorrectSound.play()

func _on_Portal_correct_2_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position

func _on_Portal_incorrect_2_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position
	incorrectSound.play()

func _on_Portal_correct_3_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position

func _on_Portal_incorrect_3_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position
	incorrectSound.play()

func _on_BackPortal_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position
	fila.fila[0].songNumber = 2

func _on_BackPortal2_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position

func _on_BackPortal1_teleportPlayer(pos: Node2D):
	fila.fila[0].position = pos.global_position
